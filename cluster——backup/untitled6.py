...
target_idx = NREL.park_id['tehachapi']
year_from,year_to=2004,2006
if sys.version_info < (3, ):
    mode = 'rU'
else:
    mode = 'r'
csvfile='cluster/SpectralClustering100.csv'
pick=[]
...
for row in turbines:
            ...
            if (turbine_index != target_idx):
                if(pick[turbine_index]==pick[target_idx]):
                    d=d+1
...
#        csv_write.writerow(res)
        print ('tehachapi feature_window:',feature_window,' mse:',mse)  
